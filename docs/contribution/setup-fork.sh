...
# upstream   https://github.com/combro2k/ProxmoxVE.git (fetch)
# upstream   https://github.com/combro2k/ProxmoxVE.git (push)
```
...
print_info "Upstream: https://github.com/combro2k/ProxmoxVE"
echo ""
