...
ADDON_SCRIPT="https://raw.githubusercontent.com/combro2k/ProxmoxVE/main/tools/addon/dokploy.sh"
...
bash -c "$(curl -fsSL https://raw.githubusercontent.com/combro2k/ProxmoxVE/main/tools/addon/dokploy.sh)"
MIGRATION_EOF
